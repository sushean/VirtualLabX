...
export default function PropertiesPanel({ selectedNode, setNodes, setEdges }) {
  if (!selectedNode) {
    return (
      <div className="p-4 bg-[var(--panel-bg)] border-l border-[var(--glass-border)] flex flex-col h-full w-72 z-10 shadow-[-2px_0_15px_rgba(0,0,0,0.5)]">
        ...
        <div className="bg-black/50 p-3 rounded border border-[var(--glass-border)] text-xs text-gray-400">
    ...
    <div className="p-4 bg-[var(--panel-bg)] border-l border-[var(--glass-border)] flex flex-col h-full w-72 z-10 shadow-[-2px_0_15px_rgba(0,0,0,0.5)]">
      ...
      <div className="mb-4">
        ...
        <input 
          ...
          className="w-full bg-black/50 border border-[var(--glass-border)] p-2 rounded text-xs text-gray-500"
        />
      </div>

      <div className="mb-4 text-xs font-bold text-gray-500 uppercase tracking-widest pb-2 border-b border-[var(--glass-border)]">Type: {selectedNode.type}</div>
      ...
      <div className="mb-6">
        ...
        <input 
          ...
          className="w-full bg-[var(--panel-bg-strong)] border border-white/20 p-2 rounded text-sm text-white focus:outline-none focus:border-purple-500"
        />
      </div>
          ...
          <div key={field.key} className="mb-6">
            ...
            {field.type === 'select' ? (
              <select 
                ...
                className="w-full bg-[var(--panel-bg-strong)] border border-white/20 p-2 rounded text-sm text-white focus:outline-none focus:border-[#00e5ff] appearance-none cursor-pointer"
              >
              ...
              <input 
                ...
                className="w-full bg-[var(--panel-bg-strong)] border border-white/20 p-2 rounded text-sm text-white focus:outline-none focus:border-[#00e5ff]"
              />
            ) : (
              <input 
                value={val}
      ...
      <div className="mt-auto p-3 bg-black/40 rounded border border-[var(--glass-border)]">
