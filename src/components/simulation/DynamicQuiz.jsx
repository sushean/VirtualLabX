    ...
    return (
      <div className="animate-page-enter max-w-3xl mx-auto flex flex-col items-center justify-center text-center mt-8">
        <div className="bg-[#110b27] border border-white/10 p-10 rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] relative overflow-hidden w-full">
           ...
           <div className="w-20 h-20 bg-gradient-to-br from-purple-500 to-[#00e5ff] rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg shadow-[#00e5ff]/30">
        ...
        <div className="bg-[#110b27] border border-white/10 p-10 rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] w-full flex flex-col items-center">
           ...
           <div className="flex flex-col md:flex-row gap-4 w-full justify-center">
              ...
              <button 
                ...
                className="px-8 py-3 bg-gradient-to-r from-[#6c2bd9] to-[#00e5ff] text-white font-bold rounded-xl shadow-[0_0_20px_rgba(0,229,255,0.3)] hover:shadow-[0_0_30px_rgba(0,229,255,0.5)] transition-all flex items-center justify-center gap-2"
              >
