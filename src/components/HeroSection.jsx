...
export default function HeroSection() {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center pt-48 pb-16 px-4 text-center overflow-hidden min-h-screen">
      ...
      {/* Flawless Edge Blending Gradients */}
      <div className="absolute inset-x-0 top-0 h-[150px] bg-linear-to-b from-[var(--background-start)] to-transparent -z-10 pointer-events-none"></div>
      <div className="absolute inset-x-0 bottom-0 h-75 bg-gradient-to-t from-[var(--background-end)] to-transparent -z-10 pointer-events-none"></div>
      ...
      <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center">
        ...
        <button 
          ...
          className="btn-primary text-xl px-10 py-4 rounded-xl shadow-[0_0_30px_rgba(108,43,217,0.5)] hover:shadow-[0_0_50px_rgba(108,43,217,0.8)] transition-all transform hover:-translate-y-1 font-bold border border-[var(--glass-border)]"
        >
          Start Experimenting
        </button>
      </div>
